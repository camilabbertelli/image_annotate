...
window = sg.Window('Image Detection Annotation', gui.layout_detection, finalize=True, return_keyboard_events=True)
...
while True:
    ...
    if event == "allImages":
        ...
        for i in range(len(allImages)):
            ...
            justNames.append(allImages[i].split(folderName)[1] + extra)
